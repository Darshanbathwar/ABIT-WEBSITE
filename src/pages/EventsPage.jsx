...
export default function EventsPage() {
  return (
    <>
      ...
      <div className="relative bg-[#0d071a] h-full font-sans text-slate-200 overflow-hidden">
            ...
            <header className="relative text-center mb-16 pt-20 pb-12 overflow-hidden rounded-lg">
              ...
              <div className="flex justify-center">
                <BlurText
                  ...
                  className="text-5xl md:text-6xl font-bold text-indigo-300 tracking-tight bg-clip-text z-10  bg-gradient-to-r from-blue-300 to-purple-400 [text-shadow:0_0_10px_rgba(196,181,253,0.3)]"
                />
              </div>
              
              {/* Glowing line */}
              <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-1/4 h-1 bg-indigo-500/100 rounded-full blur-lg z-20"></div>
              <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-1/5 h-0.5 bg-indigo-400 rounded-full z-20"></div>
            </header>
